...

{
  ...
  "description": "Include this tag and complete the relevant variables as described here : https://www.kelkoogroup.com/kelkoo-customer-service/support-for-merchants/sales-tracking-guides/google-tag-manager-implementation/",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "SIMPLE_TABLE",
    "name": "merchantInfo",
    "displayName": "Kelkoogroup merchant campaign identifier",
    "simpleTableColumns": [
      {
        "defaultValue": "",
